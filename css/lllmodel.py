...
train_generator = train_datagen.flow_from_directory('Lung',target_size=(224, 224), batch_size=batch_size,
                                                    classes = ['adenocarcinoma', 'carcinoma', 'normal','squamous'],class_mode='categorical')

test_datagen = ImageDataGenerator(rescale=1/255)


test_generator = test_datagen.flow_from_directory('Lung', target_size=(224, 224), batch_size=batch_size,
                                                  classes = ['adenocarcinoma', 'carcinoma', 'normal','squamous'],
